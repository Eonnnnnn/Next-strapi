"use strict";
(self["webpackChunkstrapi"] = self["webpackChunkstrapi"] || []).push([[268],{
...
const useFetchContentTypeLayout = (contentTypeUID) => {
  ...
  const getData = (0,react.useCallback)(
    async (uid, source) => {
      ...
      try {
        const endPoint = (0,utils/* getRequestUrl */.IF)(`content-types/${uid}/configuration`);
        const {
          data: { data }
...
function OptionColor({ children, ...props }) {
  ...
  return /* @__PURE__ */ react.createElement(index_a86253bb_esm.c.Option, { ...props }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "center", gap: 2 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { height: 2, background: color, hasRadius: true, shrink: 0, width: 2 }), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral800", ellipsis: true }, children)));
}
...
function SingleValueColor({ children, ...props }) {
  const { color } = props.data;
  return /* @__PURE__ */ react.createElement(index_a86253bb_esm.c.SingleValue, { ...props }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "center", gap: 2 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { height: 2, background: color, hasRadius: true, shrink: 0, width: 2 }), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral800", ellipsis: true }, children)));
}
