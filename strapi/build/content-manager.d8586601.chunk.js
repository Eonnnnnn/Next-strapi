(self["webpackChunkstrapi"] = self["webpackChunkstrapi"] || []).push([[994],{
...
const putCMSettingsLV = (body, slug) => {
  const { put } = (0,helper_plugin_esm/* getFetchClient */.tg)();
  return put((0,utils/* getRequestUrl */.IF)(`content-types/${slug}/configuration`), body);
};
...
const ListSettingsView = ({ layout, slug }) => {
  ...
  const listRemainingFields = Object.entries(attributes).reduce((acc, cur) => {
    ...
    const isDisplayable = (0,utils/* checkIfAttributeIsDisplayable */.ko)(fieldSchema);
  ...
  (0,react.useEffect)(() => {
    ...
    const fetchData = async (source2) => {
      try {
        ...
        const {
          data: { data }
        } = await get((0,utils/* getRequestUrl */.IF)(`components/${uid}/configuration`), {
          cancelToken: source2.token
        });
...
const useContentManagerInitData = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      } = await get((0,utils/* getRequestUrl */.IF)("init"), { cancelToken: source.token });
      notifyStatus(
        formatMessage({
...
function ReviewWorkflowsStageEE({ color, name }) {
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "center", gap: 2, maxWidth: (0,helper_plugin_esm/* pxToRem */.Q1)(300) }, /* @__PURE__ */ react.createElement(Box/* Box */.x, { height: 2, background: color, hasRadius: true, shrink: 0, width: 2 }), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { fontWeight: "regular", textColor: "neutral700", ellipsis: true }, name));
}
